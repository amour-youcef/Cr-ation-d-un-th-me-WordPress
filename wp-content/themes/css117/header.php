				...
				<div class="row">
					<div class="col-md-4">
						<!-- <img class="img-fluid" src=" -->
							 ...
							 <?php 
							 //echo $theme_opts['image_01_url']; 
							 ?> 
						
						<!-- " alt=""> -->
						<img class="img-fluid" src="screenshot.png" alt="">
						<p class="text-center"><?php echo stripslashes($theme_opts['legend_01']); ?></p>
					</div>
					<div class="col-md-8">
						<h1 class="m-up-reset">Access Code School1</h1>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras rutrum tincidunt risus, 
							quis dignissim magna facilisis a. In vehicula ipsum id nisl imperdiet tempor. 
							Vestibulum semper leo in pellentesque ullamcorper. Sed a diam lectus. 
							Duis risus purus, vehicula eu mattis sed, faucibus ac libero. 
							Donec blandit aliquet lacus</p>	
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
							Quos eveniet corporis excepturi.</p>		
					</div>
				</div>
